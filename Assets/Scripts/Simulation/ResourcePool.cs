...
namespace ShengXi.Simulation
{
    public enum ResourceType
    {
        ...
        RepairKit = 4, // 修理包：工坊合成，用于修理建筑与据点
    }

    /// <summary>
    /// 全局共享资源池：木头 / 石头 / 食物 / 建材 / 修理包。
    ...
    public class ResourcePool
    {
        ...
        private readonly int[] _amounts = new int[5];
        ...
        public void Restore(int wood, int stone, int food, int capacity, int material = 0, int repairKit = 0)
        {
            ...
            _amounts[(int)ResourceType.RepairKit] = Math.Max(0, repairKit);
