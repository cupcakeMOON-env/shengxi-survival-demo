...
namespace ShengXi.UI
{
    ...
    public class ResourceBar : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _actionPointText = CreateRow(_panel.transform, "ActionPointRow", 3, new Color(0.95f, 0.80f, 0.30f), "行动点");
        ...
        private static GameObject CreatePanel(Transform canvasTransform)
        {
            ...
            rt.sizeDelta = new Vector2(PanelWidth, 4f * RowHeight + 24f);
